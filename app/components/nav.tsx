...
export function Navbar() {
  ...
  return (
    <aside className="mb-12 tracking-tight sm:mb-16">
      <div className="flex flex-wrap items-start justify-between gap-3 lg:sticky lg:top-20">
        <nav className="min-w-0 flex-1" id="nav" aria-label="Primary navigation">
          <div className="flex flex-wrap items-start gap-1">
            ...
            <div className="group relative m-1">
              ...
              <div className={`${open ? 'flex' : 'hidden'} absolute left-0 top-full z-10 mt-1 min-w-36 flex-col border border-neutral-200 bg-white p-1 shadow-sm group-hover:flex dark:border-neutral-800 dark:bg-black`}>
